...
if __name__ == '__main__':
    ...
    model = YOLO(r'rtdetr-l.yaml').load("rtdetr-l.pt")  # 使用预训练权重训练
    # Trainparameters ----------------------------------------------------------------------------------------------
    model.train(
        data=r'F:\ultralytics-main\ultralytics\cfg\datasets\coco8.yaml',
        ...
        name='detr',  # (str, optional) experiment name, results saved to 'project/name' directory
        ...
        fraction=0.0,  # (float) dataset fraction to train on (default is 1.0, all images in train set)
